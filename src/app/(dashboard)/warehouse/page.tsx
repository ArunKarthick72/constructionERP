                    ...
                    filtered.map((item) => {
                      ...
                      return (
                        <tr key={item.id}>
                          ...
                          <td>
                            {isEmpty ? (
                              <span className="badge badge-red"><AlertTriangle className="w-3.5 h-3.5 mr-1" />Out of Stock</span>
                            ) : isLow ? (
                              <span className="badge badge-yellow"><AlertTriangle className="w-3.5 h-3.5 mr-1" />Low Stock</span>
                            ) : (
